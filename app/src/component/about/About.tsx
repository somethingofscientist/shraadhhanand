    ...
    <section id='about'>
      ...
      <div className={styles.container}>
        <div className={styles.left}>
          <Fade direction='left'>
            <div className={styles.card2} id={styles.card_1}>
              <div className={styles.company}>
                <div className={styles.company_logo}>
                  <img loading='lazy' src='/images/logo/nxcar.jpg' alt="" />
                </div>
              ...
              <div className={styles.time_container}>
                ...
                <span className={styles.my_role}>June 2024  - March 2026 </span>
              </div>
          ...
          <Fade direction='right'>
            <div className={styles.card2} id={styles.card_2}>
              <div className={styles.company}>
                <div className={styles.company_logo}>
                  <img src='/images/logo/dp.jpg' alt="" />
                </div>
                <div className={styles.company_name}>
                  Digital Panther
                </div>
            ...
            <div className={styles.card2} id={styles.card_2}>
              <div className={styles.company}>
                <div className={styles.company_logo}>
                  <img
                    loading='lazy'
                    src='/images/logo/applore.png' alt="" />
                </div>
                <div className={styles.company_name}>
              ...
              <div className={styles.company_link}>
                <Link
                  href='https://apploretechnologies.com/'
                  target='_blank'
                >
                  Applore.in
                </Link>
